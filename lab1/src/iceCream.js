function calculateIceCreamCost() {
  ...
  var size =
    (_a = prompt("Оберіть розмір стаканчика (маленький або великий):")) ===
      null || _a === void 0
      ? void 0
      : _a.toLowerCase();
  var cost = 0;
  ...
  var marshmallow =
    (_c = prompt("Чи хочете ви додати маршмелоу? (так/ні):")) === null ||
    _c === void 0
      ? void 0
      : _c.toLowerCase();
  if (marshmallow === "так") {
...
if (totalCost > 0) {
  alert(
    "\u0417\u0430\u0433\u0430\u043B\u044C\u043D\u0430 \u0432\u0430\u0440\u0442\u0456\u0441\u0442\u044C \u0432\u0430\u0448\u043E\u0433\u043E \u043C\u043E\u0440\u043E\u0437\u0438\u0432\u0430: ".concat(
      totalCost,
      " \u0433\u0440\u043D"
    )
  );
